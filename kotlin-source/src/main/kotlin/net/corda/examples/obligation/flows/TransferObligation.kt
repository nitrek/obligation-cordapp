...
object TransferObligation {
    ...
    class Initiator(private val linearId: UniqueIdentifier,
        ...
        override fun call(): SignedTransaction {
            ...
            check(ourIdentity == borrower) { "Obligation transfer can only be initiated by the Lead Banker." }
            ...
            val sessions = listOf(lenderIdentity, newLender).toSet().map { party: Party -> initiateFlow(party) }.toSet()
